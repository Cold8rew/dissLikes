...
/*	public void getAllInfoClass() throws SQLException {
	...
	public InprogressVO getinfoVotes(String img_name) throws SQLException {
		...
		if(rs.next()) {
			...
			iVo = new InprogressVO(vt_id, vt_name, vt_img_name, vt_img_path, vt_ag_name, vt_total_num, vt_ag_num, 
									vt_dag_num, vt_indate, vt_stdate, vt_enddate, vt_type, vt_dtype);
		} else {
			iVo = null;
