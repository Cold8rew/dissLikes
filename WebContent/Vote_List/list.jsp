...
<table width=100%>
   ...
   <c:when test="${vo1.getDday()>=0}">
      <tr>
         <!-- 좋아요 -->
         <td>
         <a href="Result.do?img_name=${vo1.vt_img_name}&result=호"><span class="container" >
         ...
         <!-- 싫어요 -->
         <td><a href="Result.do?img_name=${vo1.vt_img_name}&result=불호"><span class="container">                                       
   ...
   <c:when test="${vo1.getDday()<0}">
      <tr>
         <td colspan="2" id="vote_end" name="vt_id"><a href="Close_One.do?img_name=${vo1.vt_img_name}">종료된 투표입니다.</a></td>
      </tr>
      <tr class="end_title">
