...
<section id="container">
	...
	<div class=btn_ca><button class="btn_category">음식</button></div>
	<!-- 카테고리 정해지면 버튼변경 -->
	
	<div class=title>${ sVo.vt_name }<!-- 민트초코 --></div><br>
	<!-- 민트초코는 예시입니다. -->
	
	<article class="block2-1">
		<!-- <div class="vote_img"> -->
			<img src="${sVo.vt_img_path }" class="center" alt=center_img>
	...
	<article class="block2-3">
    	...
    	<a href="https://www.kakaocorp.com/page/service/service/KakaoTalk"><img src="After_Click/img/Line_logo.png" class="line"></a>
