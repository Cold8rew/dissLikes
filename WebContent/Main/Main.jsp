...
function leftImge() {
	var result="호";
	var img_name=idlist[Num];
	window.location.href ='<c:url value="Result.do"/>?img_name='+img_name+'&result='+result;
}
...
<article>
      <div class="title">
         <a href="allList.do" id="list"> 진행중인 호불호 조사 > </a>
      </div>
      <div class="pro">
         <div class="pro_item" style="width: 1180px;">
            <img class="left" src="Main/img/left.png" onclick="leftMove()">
            <img class="pro_img" id="proId1" 
            	onmouseover="good(this)" onmouseout="back(this)" onclick="leftImge()"
           ><img class="pro_img" id="proId2" 
            	onmouseover="bad(this)" onmouseout="back(this)" onclick="rightImge()">
            <img class="right" src="Main/img/right.png" onclick="rightMove()">
         </div>
         <div class="pro_name">
	...
	<div>
      <%if(session.getAttribute("nick") == null){%>
         <a href="" class="vote_making" onclick="needlogin()">
            <img src="Main/img/making_button.PNG">
         </a>
      <%}else{%>
